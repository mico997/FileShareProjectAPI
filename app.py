...
app = Flask(__name__)
app.config["SQLALCHEMY_DATABASE_URI"] = "postgres://aubdszrumiuths:4d5d1cd63ccf7e13e339f8b221bd98742b120162ae33e5976ce1246fa0f85988@ec2-18-232-143-90.compute-1.amazonaws.com:5432/d74vpe560b2lct"
...
def add_file():
    ...
    return jsonify("File Added Succestfully")
